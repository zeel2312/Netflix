        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form action="{{ route('upload') }}" id="adduser" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            @csrf
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Name* </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="name" name="name" class="form-control" placeholder="Enter your full name" title="Please enter full name" required=" ">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="date_of_birth" name="date_of_birth" class="date-picker form-control" placeholder="dd-mm-yyyy" title="Please enter birth date" type="text" required=" " onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                                    <script>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="password" id="confirm_password" name="confirm_password" required=" " class="form-control" placeholder="Re-type Password" title="Please enter a password that match">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="profile_image">Upload Profile* </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="file" name="profile_image" id="profile_image" required=" " title="Please upload image" class="form-control dropify" />
                                </div>
                            </div>
