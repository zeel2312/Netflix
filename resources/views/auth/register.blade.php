                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="contact-form-wrap">
                        <div class="widget-title mb-50">
                            <h5 class="title">Netflix Register</h5>
                        </div>
                        <div class="contact-form">
                            <form method="POST" id="validateUser" action="{{ route('register') }}" >
                                @csrf
                                <div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <label class="col-md-4 col-form-label text-md-end" for="password-confirm">Confirm Password *</label>
                                        <div class="col-md-6">
