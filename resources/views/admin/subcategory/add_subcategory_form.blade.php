    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Add New Sub-Category Form</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form action="{{ route('admin.uploadSubCategory') }}" id="addSubCategory" method="POST" class="form-horizontal form-label-left">
                            @csrf
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align unique" for="SubCategoryName">Sub-Category Name* </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="name" name="name" class="form-control" placeholder="Enter Sub-Category Name" required=" ">
                                </div>
                            </div>
                            <div class="item form-group">
